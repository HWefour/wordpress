...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'integration_499cebfa4f4a29b42905_20230203151130_archive.zip';
        const ARCHIVE_SIZE       = '52273427';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '499cebf-03151130';
        const SECONDARY_PACKAGE_HASH = '23a9937-03151130';
